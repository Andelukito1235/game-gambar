...
public class RekorDunia extends Activity {
	private EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_rekor_dunia);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "REKOR DUNIA";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.rekor_dunia, menu);
		return true;
	}
