...
public class NaikHaji extends Activity {
	private EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_naik_haji);
	...
	public void cekjawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),RekorDunia.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.naik_haji, menu);
		return true;
	}
