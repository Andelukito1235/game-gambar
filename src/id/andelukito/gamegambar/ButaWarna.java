...
public class ButaWarna extends Activity {
	...
	public void cekjawaban(View v){
		String jawabanBenar = "BUTA WARNA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),GudangPeluru.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.buta_warna, menu);
		return true;
	}
