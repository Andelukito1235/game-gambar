package id.andelukito.gamegambar;
...
public class BaskomAir extends Activity {

	private EditText jawaban;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_baskom_air);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "BASKOM AIR";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),ButaWarna.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.baskom_air, menu);
		return true;
	}
